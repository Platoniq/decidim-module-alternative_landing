...
Features:
  ...
  - Fix: filter landing map by hash takes into account the status of categories
...
Features:
  - Fix: Prevents overrides for menus not specified in landing config
...
Features:
  - Improve landing map categories visualization
  - Fix image uploader
